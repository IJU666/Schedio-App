...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const EditTugasScreen(),
    );
  }
}

class EditTugasScreen extends StatefulWidget {
  const EditTugasScreen({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text(
                    'Setiap kelompok memilih satu topik dari daftar berikut Aplikasi harus diusul menggunakan Flutter, menyimpan data menggunakan Firebase atau Hive dan mendukungCRUD (Create, Read, Update, Delete) Seluruh fitur login (jika ada) wajib menggunakan Firebase Authentication.',
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.grey,
                      height: 1.5,
